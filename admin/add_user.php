        ...
        <div class="min-h-screen bg-gray-100 p-1.5 sm:p-12 sm:pt-0">
            <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg rounded-3xl">
                ...
                <form action="" post="post">
                    ...
                    <div class="flex w-full h- items-center justify-center bg-grey-lighter">
                        <label class="w-64 flex flex-col items-center mt-4 px-3 py-3 bg-white text-pink-500 rounded-lg shadow-lg tracking-wide uppercase border border-blue transition-all duration-500 ease-linear cursor-pointer hover:bg-blue-400 hover:text-white">
                            <svg class="w-8 h-8" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                                <path d="M16.88 9.1A4 4 0 0 1 16 17H5a5 5 0 0 1-1-9.9V7a3 3 0 0 1 4.52-2.59A4.98 4.98 0 0 1 17 8c0 .38-.04.74-.12 1.1zM11 11h3l-4-4-4 4h3v3h2v-3z" />
                            </svg>
                            <span class="mt-2 text-base leading-normal">Import excel</span>
                            <input type='file' class="hidden"/>
                        </label>
                    </div>
                    <div class="flex justify-center">
                        <button type="submit" class="px-2 py-1.5 w-60 mt-3 text-lg text-white transition-all duration-150 ease-linear rounded-lg shadow outline-none bg-pink-500 hover:bg-pink-600 hover:shadow-lg focus:outline-none">submit</button>
                    </div>
                </form>
            </div>
        </div>
